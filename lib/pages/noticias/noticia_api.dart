...
class VideosApi{
  static Future<List<NoticiaRecente>> getNoticia() async{
    ...
    noticiaRecentes.add(NoticiaRecente(nome:"Coronavírus em Alta",
        urlFoto:"https://ichef.bbci.co.uk/news/320/cpsprodpb/1318A/production/_113881287_gettyimages-1204224469-1.jpg",
        desc: "https://g1.globo.com/bemestar/coronavirus/noticia/2020/09/26/casos-e-mortes-por-coronavirus-no-brasil-em-26-de-setembro-segundo-consorcio-de-veiculos-de-imprensa.ghtml",
        urlVideo: "https://www.youtube.com/watch?v=HDNXGeWDBoY"));
